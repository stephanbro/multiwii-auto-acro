...
/*************************************************************************************************/
  ...
  /****************************    Mincommand          *******************************/
    ...
    #define MINCOMMAND 1460 // multiwii3d (simonk)
 ...
 */
  ...
  /**************************************************************************************/
   ...
   /* GPS protocol 
    ...
    #define NAV_SLEW_RATE              15       // Adds a rate control to nav output, will smoothen out nav angle spikes
  ...
  /********************************************************************/
    ...
    #define VBATSCALE       133 // (*) (**) change this value if readed Battery voltage is different than real voltage
    #define VBATNOMINAL     126 // 12,6V full battery nominal voltage - only used for lcd.telemetry
    #define VBATLEVEL_WARN1 107 // (*) (**) 10,7V
    #define VBATLEVEL_WARN2  99 // (*) (**) 9.9V
    #define VBATLEVEL_CRIT   93 // (*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
    #define NO_VBAT          40 // Avoid beeping without any battery
